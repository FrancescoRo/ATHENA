...
#Global parameters
M =  500#This is the number of data points to use
m = 8
D = 1000
folds = 3
...
GPR_NAS = Estimator([params_opt],'NAS',D,fm,None,'exact',kernel=None,gp_dimension=1,plot=True)
